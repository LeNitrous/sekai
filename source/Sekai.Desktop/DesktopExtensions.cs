...
{
    public static HatPosition ToHatPosition(this Silk.NET.GLFW.JoystickHats hat)
    {
        switch (hat)
        {
    ...
    public static MouseButton ToMouseButton(this Silk.NET.GLFW.MouseButton button)
    {
        switch (button)
        {
    ...
    public static Key ToKey(this Silk.NET.GLFW.Keys key)
    {
        switch (key)
        {
