...
public partial class Buffer
{
    ...
    {
        /// <summary>
        /// Creates a new strongly-typed index buffer.
        /// </summary>
        ...
        /// <returns>A new strongly-typed index buffer.</returns>
            ...
            where T : unmanaged, IBinaryInteger<T>
        {
            ...
            var usage = Veldrid.BufferUsage.IndexBuffer;
            ...
            return new(device.Factory.CreateBuffer(new((uint)(count * Unsafe.SizeOf<T>()), usage)), BufferKind.Index, dynamic);
        }
