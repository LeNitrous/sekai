...
{
    private const double gelfond_const = 23.1406926327792690;            // e to the power of Pi = (-1) to the power of -i
    private const double gelfond_schneider_const = 2.6651441426902251;    // 2 to the power of sqrt(2)
    ...
    private const uint underflow_guard = 0xFFFF;
