...
public abstract class Storage : IDisposable
{
    ...
    public Storage OpenDirectory(string path) => Exists(path) ? new SubDirectoryStorage(this, path) : throw new FileNotFoundException(null, Path.GetFileName(path));
    ...
    public abstract IEnumerable<string> EnumerateFiles(string path, string pattern = "*", SearchOption options = SearchOption.TopDirectoryOnly);
    ...
    public abstract IEnumerable<string> EnumerateDirectories(string path, string pattern = "*", SearchOption options = SearchOption.TopDirectoryOnly);
