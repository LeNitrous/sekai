...
{
    /// <summary>
    /// The graphics API the device is using.
    /// </summary>
    public abstract GraphicsAPI API { get; }

    /// <summary>
    /// The graphics adapter this device is using.
    /// </summary>
    ...
    /// </summary>
    public abstract SyncMode SyncMode { get; set; }
    ...
    /// <summary>
    /// Sts the scissor rectangle of the device.
    /// </summary>
    ...
    /// <summary>
    /// Creates a graphics device from an <see cref="ISurface"/>.
    /// </summary>
    /// <param name="surface">The surface.</param>
    /// <returns>A new graphics device.</returns>
    /// <exception cref="NotSupportedException">Thrown when <see cref="GraphicsDevice"/> does not support the surface.</exception>
    public static GraphicsDevice Create(ISurface surface)
    {
        if (surface.Flags.HasFlagFast(SurfaceFlags.OpenGL))
        {
            return CreateOpenGL(surface.GL!);
        }
    ...
    /// <summary>
    /// Creates a new dummy graphics device.
    /// </summary>
    /// <returns>A new dummy graphics devices.</returns>
    public static GraphicsDevice CreateDummy()
    {
        return new DummyGraphicsDevice();
    }

    /// <summary>
    /// Creates a new OpenGL graphics device.
    /// </summary>
    ...
    public static GraphicsAPI GetPreferredAPI()
    {
    ...
    public static IEnumerable<GraphicsAPI> GetAvailableAPIs()
    {
        if (RuntimeInfo.IsWindows)
        ...
        if (RuntimeInfo.IsBrowser)
        {
            yield return GraphicsAPI.WebGPU;
        }
        else
        {
